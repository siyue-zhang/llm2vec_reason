...
class HybridLoss:
    ...
    def __call__(
        ...
        reasoning_loss_fn = self.cross_entropy_loss
        reasoning_loss = reasoning_loss_fn(reasoning_output.logits.view(-1, reasoning_output.logits.size(-1)), reasoning_target.view(-1))

        loss = retrieval_loss + reasoning_loss
