...
from llm2vec import LLM2Vec, LLM2VecWithDecoder
...
class LLM2VecWithDecoderSupervisedTrainer(Trainer):
    def __init__(
        self,
        *args,
        loss_function=None,
...
def main():
    ...
    model = LLM2VecWithDecoder.from_pretrained_decoder(
        encoder = encoder,
        base_model_name_or_path=model_args.model_name_or_path,
        peft_model_name_or_path=model_args.peft_model_name_or_path,
        merge_peft=True,
    ...
    elif custom_args.loss_class == "HybridLoss":
    ...
    trainer = LLM2VecWithDecoderSupervisedTrainer(
        model=model,
        args=training_args,
